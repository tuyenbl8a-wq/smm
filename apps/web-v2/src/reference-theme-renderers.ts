...
const themedScreens: Record<string, ThemeScreens> = {
  AI_COSMIC_FUTURE: {
    landing: {
      ...
      regions: `<nav class="theme-navigation ai-orbit-nav"><output>${brand}<span>TRANG CHỦ</span><a href="#services">DỊCH VỤ</a><a href="#pricing">BẢNG GIÁ</a><a href="/login">ĐĂNG NHẬP</a><a class="ai-nav-cta" href="/register">ĐĂNG KÝ NGAY →</a></output></nav><section class="theme-story ai-neural-core"><output><small>NỀN TẢNG SMM THÔNG MINH TẠI VIỆT NAM</small><strong data-theme-content="heroTitle">Tăng trưởng thương hiệu của bạn với sức mạnh AI</strong><p data-theme-content="heroSubtitle">Kết hợp trí tuệ nhân tạo để tối ưu chiến lược, tiết kiệm thời gian và mang lại kết quả vượt trội.</p><div class="ai-hero-actions"><a data-theme-href="primaryCtaUrl" href="/register"><span data-theme-content="primaryCta">Bắt đầu ngay</span> →</a><a href="#pricing">Xem bảng giá</a></div><i class="ai-planet" aria-hidden="true"></i><i class="ai-robot" aria-hidden="true"><b class="ai-robot-head"></b><b class="ai-robot-body"><span>AI</span></b><b class="ai-robot-arm"></b></i><i class="ai-road" aria-hidden="true"></i><span class="ai-chip ai-chip-one">♫ TẠO NỘI DUNG AI</span><span class="ai-chip ai-chip-two">◈ PHÂN TÍCH DỮ LIỆU</span><span class="ai-chip ai-chip-three">✦ TỐI ƯU TỰ ĐỘNG</span><span class="ai-chip ai-chip-four">◎ LÊN CHIẾN LƯỢC</span></output></section><aside class="theme-offer ai-signal-panel"><output><small>AI HỖ TRỢ 24/7</small><b>99.8%</b><span>Hiệu quả thực tế</span></output></aside><footer class="theme-cta ai-command-strip"><output><span>f&nbsp;&nbsp;◎&nbsp;&nbsp;♪&nbsp;&nbsp;▶&nbsp;&nbsp;✈&nbsp;&nbsp;𝕏</span>${tagline}</output></footer>`,
    },
    auth: {
      renderer: "ai-cognitive-gateway",
      regions: `<nav class="auth-navigation ai-auth-status"><output>${brand}<span>AI-POWERED SMM PLATFORM</span></output></nav><section class="auth-visual ai-identity-orbit"><output><small>AI FOR A BRIGHTER CREATOR ECONOMY</small><h1>Chào mừng bạn trở lại!</h1><p>Đăng nhập để tiếp tục hành trình tăng trưởng cùng AI.</p><i class="ai-city-window" aria-hidden="true"><b></b></i></output></section><aside class="auth-form-region ai-auth-guide"><output><b>AN TOÀN TUYỆT ĐỐI</b><span>Bảo mật và ổn định</span><span>MORE HUMAN POTENTIAL ONLINE</span></output></aside><footer class="auth-assurance ai-auth-foot"><output>MORE THAN SERVICES · A SMARTER TOMORROW</output></footer>`,
    },
    customer: {
      renderer: "ai-intelligence-console",
      regions: `<nav class="dashboard-navigation ai-console-nav"><output><span class="ai-agent-orb">AI</span><b>AI Assistant</b><small>ĐANG ONLINE</small></output></nav><section class="dashboard-wallet ai-prediction"><output><small>HIỆU SUẤT TĂNG TRƯỞNG</small><h2>Tăng trưởng</h2><b>Dữ liệu trực tiếp</b></output></section><aside class="dashboard-kpis ai-model-stack"><output><span>Tương tác</span><span>Lượt xem</span><span>Đơn hàng</span><span>Tỷ lệ thành công</span></output></aside><footer class="dashboard-orders ai-queue"><output><b>Trợ lý AI của bạn</b><span>Xin chào! Tôi có thể giúp bạn tối ưu chiến dịch.</span><a href="/orders">Mở trung tâm điều hành →</a></output></footer>`,
    },
  },
  CREATOR_POP: {
    landing: {
