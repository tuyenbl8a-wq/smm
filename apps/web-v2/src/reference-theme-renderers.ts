...
const themedScreens: Record<string, ThemeScreens> = {
  AI_COSMIC_FUTURE: {
    landing: {
      renderer: "ai-reference-landing",
      regions: `<nav class="theme-navigation ai-reference-nav"><output>${brand}<span>Trang chủ</span><a href="#services">Dịch vụ⌄</a><a href="#pricing">Bảng giá</a><span>AI Tools</span><span>Blog</span><span>Liên hệ</span><a class="ai-login-link" href="/login">Đăng nhập</a><a class="ai-register-link" href="/register">Đăng ký ngay →</a></output></nav><section class="theme-story ai-reference-hero"><output><small>NỀN TẢNG SMM THÔNG MINH TẠI VIỆT NAM</small><strong data-theme-content="heroTitle">Tăng trưởng thương hiệu của bạn với sức mạnh AI</strong><p data-theme-content="heroSubtitle">Cung cấp các dịch vụ Social Media Marketing chất lượng cao, kết hợp trí tuệ nhân tạo để tối ưu chiến lược, tiết kiệm thời gian và mang lại kết quả vượt trội.</p><div class="ai-reference-actions"><a data-theme-href="primaryCtaUrl" href="/register"><span data-theme-content="primaryCta">Bắt đầu ngay</span> →</a><a href="#pricing">Xem bảng giá</a></div><div class="ai-reference-scene" aria-hidden="true"><i class="ai-reference-planet"></i><i class="ai-reference-city"></i><i class="ai-reference-road"></i><i class="ai-reference-orb">AI</i><i class="ai-humanoid"><b class="ai-humanoid-head"></b><b class="ai-humanoid-neck"></b><b class="ai-humanoid-torso"><span>♛</span></b><b class="ai-humanoid-shoulder"></b><b class="ai-humanoid-forearm"></b><b class="ai-humanoid-hand"></b></i></div><div class="ai-floating-stack" aria-hidden="true"><span class="ai-float-strategy">◉ LÊN CHIẾN LƯỢC<small>AI STRATEGY</small></span><span class="ai-float-content">♪ TẠO NỘI DUNG<small>AI CONTENT</small></span><span class="ai-float-social">f&nbsp;&nbsp;◎&nbsp;&nbsp;✈&nbsp;&nbsp;𝕏</span><span class="ai-float-analysis">▣ PHÂN TÍCH DỮ LIỆU<small>AI ANALYTICS</small></span><span class="ai-float-optimize">⚙ TỐI ƯU TỰ ĐỘNG<small>AI OPTIMIZATION</small></span></div></output></section><aside class="theme-offer ai-reference-promise"><output><b>THƯƠNG HIỆU LỚN</b><span>BẮT ĐẦU TỪ HÔM NAY</span></output></aside><footer class="theme-cta ai-platform-strip"><output><span>● Facebook</span><span>▣ Instagram</span><span>♪ TikTok</span><span>▶ YouTube</span><span>✈ Telegram</span><span>𝕏 X (Twitter)</span></output></footer>`,
    },
    auth: {
      renderer: "ai-reference-auth",
      regions: `<nav class="auth-navigation ai-auth-brand"><output>${brand}</output></nav><section class="auth-visual ai-auth-portal"><output><span class="ai-portal-label">FUTURISTIC CITY PORTAL</span><i class="ai-portal-sky"></i><i class="ai-portal-city"></i><i class="ai-portal-road"></i></output></section><aside class="auth-form-region ai-auth-manifesto"><output><b>AI<br>FOR A<br>BRIGHTER<br>CREATOR<br>ECONOMY</b><span>${brand}</span><small>MORE THAN SERVICES<br>A SMARTER TOMORROW</small><q>Công nghệ mở rộng cơ hội cho mọi người.</q></output></aside><footer class="auth-assurance ai-auth-frame"><output>AI-POWERED SECURE ACCESS</output></footer>`,
    },
    customer: {
      renderer: "ai-reference-customer",
      regions: `<nav class="dashboard-navigation ai-customer-signature"><output><span>♛</span>${brand}</output></nav><section class="dashboard-wallet ai-customer-heading"><output><h2>Tổng quan</h2><p>Cùng AI theo dõi hiệu suất và tối ưu chiến lược của bạn.</p></output></section><aside class="dashboard-kpis ai-customer-status"><output><span>● Hệ thống AI đang online</span></output></aside><footer class="dashboard-orders ai-customer-motto"><output><q>Dữ liệu hôm nay. Tăng trưởng ngày mai.</q><span>SMART TOOLS. REAL GROWTH.</span></output></footer>`,
    },
  },
  CREATOR_POP: {
    landing: {
