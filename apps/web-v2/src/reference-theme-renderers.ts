...
const themedScreens: Record<string, ThemeScreens> = {
  AI_COSMIC_FUTURE: {
    landing: {
      renderer: "ai-reference-landing-v2",
      regions: `<nav class="theme-navigation aiv2-nav"><output>${brand}<span>Trang chủ</span><a href="#services">Dịch vụ⌄</a><a href="#pricing">Bảng giá</a><span>AI Tools</span><span>Blog</span><span>Liên hệ</span><a class="aiv2-login" href="/login">Đăng nhập</a><a class="aiv2-register" href="/register">Đăng ký ngay →</a></output></nav><section class="theme-story aiv2-hero"><output><small>NỀN TẢNG SMM THÔNG MINH TẠI VIỆT NAM</small><strong data-theme-content="heroTitle">Tăng trưởng thương hiệu của bạn với sức mạnh AI</strong><p data-theme-content="heroSubtitle">Cung cấp các dịch vụ Social Media Marketing chất lượng cao, kết hợp trí tuệ nhân tạo để tối ưu chiến lược, tiết kiệm thời gian và mang lại kết quả vượt trội.</p><div class="aiv2-actions"><a data-theme-href="primaryCtaUrl" href="/register"><span data-theme-content="primaryCta">Bắt đầu ngay</span> →</a><a href="#pricing">Xem bảng giá</a></div><div class="aiv2-scene" aria-hidden="true"><i class="aiv2-planet"></i><i class="aiv2-city"></i><i class="aiv2-road"></i><i class="aiv2-orb">AI</i><i class="aiv2-robot"><b class="aiv2-robot-head"></b><b class="aiv2-robot-neck"></b><b class="aiv2-robot-torso"><span>♛</span></b><b class="aiv2-robot-arm"></b><b class="aiv2-robot-hand"></b></i></div><div class="aiv2-floats" aria-hidden="true"><span class="aiv2-float-strategy">◉ LÊN CHIẾN LƯỢC<small>AI STRATEGY</small></span><span class="aiv2-float-content">♪ TẠO NỘI DUNG<small>AI CONTENT</small></span><span class="aiv2-float-social">f&nbsp;&nbsp;◎&nbsp;&nbsp;✈&nbsp;&nbsp;𝕏</span><span class="aiv2-float-analysis">▣ PHÂN TÍCH DỮ LIỆU<small>AI ANALYTICS</small></span></div></output></section><aside class="theme-offer aiv2-promise"><output><b>THƯƠNG HIỆU LỚN</b><span>BẮT ĐẦU TỪ HÔM NAY</span></output></aside><footer class="theme-cta aiv2-platforms"><output><span>● Facebook</span><span>▣ Instagram</span><span>♪ TikTok</span><span>▶ YouTube</span><span>✈ Telegram</span><span>𝕏 X (Twitter)</span></output></footer>`,
    },
    auth: {
      renderer: "ai-reference-auth-v2",
      regions: `<nav class="auth-navigation aiv2-auth-brand"><output>${brand}</output></nav><section class="auth-visual aiv2-auth-portal"><output><span class="aiv2-portal-label">FUTURISTIC CITY PORTAL</span><i class="aiv2-portal-sky"></i><i class="aiv2-portal-city"></i><i class="aiv2-portal-road"></i></output></section><aside class="auth-form-region aiv2-auth-manifesto"><output><b>AI<br>FOR A<br>BRIGHTER<br>CREATOR<br>ECONOMY</b><span>${brand}</span><small>MORE THAN SERVICES<br>A SMARTER TOMORROW</small><q>Công nghệ mở rộng cơ hội cho mọi người.</q></output></aside><footer class="auth-assurance aiv2-auth-frame"><output>AI-POWERED SECURE ACCESS</output></footer>`,
    },
    customer: {
      renderer: "ai-reference-customer-v2",
      regions: `<nav class="dashboard-navigation aiv2-customer-signature"><output><span>♛</span>${brand}</output></nav><section class="dashboard-wallet aiv2-customer-heading"><output><h2>Tổng quan</h2><p>Cùng AI theo dõi hiệu suất và tối ưu chiến lược của bạn.</p></output></section><aside class="dashboard-kpis aiv2-customer-status"><output><span>● Hệ thống AI đang online</span></output></aside><footer class="dashboard-orders aiv2-customer-motto"><output><q>Dữ liệu hôm nay. Tăng trưởng ngày mai.</q><span>SMART TOOLS. REAL GROWTH.</span></output></footer>`,
    },
  },
  CREATOR_POP: {
    landing: {
