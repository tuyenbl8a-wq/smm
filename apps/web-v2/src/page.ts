...
function shell(
  ...
  return `<!doctype html><html lang="vi"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="description" content="${description}"><title>${title} · DichVu1st</title><style>${styles}${themeStyles}</style></head><body>${body}${primitives}<script>${script}</script></body></html>`;
}
